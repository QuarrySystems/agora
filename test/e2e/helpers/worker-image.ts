...
//      tagged release of `ghcr.io/quarrysystems/agora-worker` (workflow run
//      26312255859, pushed 2026-05-22). Refresh when cutting a new tagged
//      release; the agora-worker-image workflow emits the digest in its
...
export const WORKER_IMAGE =
  ...
  'ghcr.io/quarrysystems/agora-worker@sha256:ef7d6e014609f93ac45cb64911f700b1cb936df03c52f73f2b4e2594d45142e2';
