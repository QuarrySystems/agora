#!/usr/bin/env sh
# init-buckets.sh — one-shot MinIO bucket initialisation for the Claims-Appeals demo.
#
...
#
# Buckets created:
#   pangolin-audit  — Object Lock enabled (COMPLIANCE mode) — tamper-evident / external-immutable
#   pangolin-data   — standard bucket (storage + mailbox)
#
