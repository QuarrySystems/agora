...
template: splash
hero:
  tagline: Submit a DAG of agent tasks. Fan out safely under file-locks. Get back reviewable patches and a verifiable audit trail — tamper-detecting by default, tamper-evident at the S3 Object Lock tier.
  actions:
