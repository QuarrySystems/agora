...
description: Embedding Pangolin Scale in a product, or need enterprise compliance modules and support? Start a white-glove pilot — run your agents on Pangolin Scale, in your account, and walk away with a verifiable audit bundle.
sidebar:
  order: 99
---
...
You're building an **agent product** — and your buyers are security- or
...
**with** design partners — not a finished product you wait on.

## Start with a pilot (white-glove)

For the first partners, **we are the platform**: we set Pangolin Scale up around your
agents, run them in your account, and hand you the audit bundle — free, in
