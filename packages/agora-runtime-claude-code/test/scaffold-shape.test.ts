...
describe("agora-runtime-claude-code scaffold shape", () => {
  it("package name is @quarry-systems/agora-runtime-claude-code", () => {
    expect(pkg.name).toBe("@quarry-systems/agora-runtime-claude-code");
  });
  ...
  it("README lists reservedPath agora-plugins.json", () => {
    expect(readme).toContain("agora-plugins.json");
  });
});
