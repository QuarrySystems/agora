...
import { UnpinnedImageError } from '@quarry-systems/agora-core';
import type { TaskSpec, ProviderContext } from '@quarry-systems/agora-core';
...
describe('LocalDockerProvider.run — container creation contract', () => {
  ...
  it('sets Labels including agora.dispatchId for post-hoc discovery', async () => {
    ...
    expect(arg.Labels['agora.dispatchId']).toBe('dispatch-xyz');
  });
