...
// `@quarry-systems/agora-core` (§5.8). Used by the overlay engine for
// adapter-reserved paths and for agora-defined manifest paths (§6.3).
//
...
import type { MergeRule } from "@quarry-systems/agora-core";
